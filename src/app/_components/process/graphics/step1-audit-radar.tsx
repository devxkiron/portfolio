...
export const Step1AuditRadar: React.FC = () => {
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center gap-4 sm:gap-8 bg-[#1a2e21] dark:bg-[#090d0a] p-4 sm:p-6 lg:p-10 sm:flex-row transition-colors duration-200">
      {/* Radar Section */}
      <div className="flex flex-col items-center justify-center">
        {/* Radar Scanner Visual with Continuous Rotation */}
        <div className="relative flex h-28 w-28 sm:h-36 sm:w-36 lg:h-44 lg:w-44 items-center justify-center overflow-hidden rounded-full border border-brand-neon/30 bg-[#13251a] dark:bg-[#0c140e] shadow-[0_0_24px_rgba(174,255,0,0.08)]">
          {/* Outer ring */}
        ...
        <p className="mt-2 sm:mt-3 font-mono text-[10px] sm:text-xs tracking-wider text-zinc-200 dark:text-zinc-300">
          Analyzing Workflows..
        </p>
      </div>
      ...
      <div className="flex w-full max-w-sm flex-col gap-2 sm:gap-3">
        {/* Item 1 */}
        <div className="flex items-center justify-between gap-2.5 rounded-lg border border-brand-neon/60 bg-[#13251a]/90 dark:bg-[#0d170f]/90 px-3 py-2 sm:px-4 sm:py-2.5 shadow-[0_0_10px_rgba(174,255,0,0.06)]">
        ...
        {/* Item 3 */}
        <div className="flex items-center justify-between gap-2.5 rounded-lg border border-white/10 dark:border-zinc-800 bg-[#13251a]/60 dark:bg-[#0d130f]/60 px-3 py-2 sm:px-4 sm:py-2.5">
          <div className="flex items-center gap-2.5">
            <Cpu className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-zinc-400 dark:text-zinc-500 shrink-0" />
            <span className="font-mono text-[11px] sm:text-xs font-medium tracking-tight text-zinc-300 dark:text-zinc-400">
              Cross-Tool CRM Synchronization
            </span>
          </div>
          <Circle className="h-3.5 w-3.5 sm:h-4 sm:w-4 shrink-0 text-zinc-500 dark:text-zinc-600" />
        </div>
      </div>
    </div>
  );
